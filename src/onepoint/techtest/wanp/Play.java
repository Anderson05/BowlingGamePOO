...
public class Play {
	...
	public static void main(String[] args) throws Exception {
		...
		if (game.numberOfRolls() < BowlingGame.NUMBER_OF_ROLLS_PER_GAME) {
			...
			// int gameScore = 0;
			System.out.println("Game summary \n " + "Player : " + game.getPlayer() + " - MAX ROLLS : "
					+ BowlingGame.NUMBER_OF_ROLLS_PER_GAME);
			for (int i = 0; i < BowlingGame.NUMBER_OF_ROLLS_PER_GAME; i++) {
				System.out.println("Roll #" + game.getRollAt(i).getNumber() + " : " + game.getRollAt(i).getPinsKnocked()
						+ " - " + game.getRollAt(i).getDetails() + " Pins" + " | " + game.getRollAt(i).getResult()
						+ " | " + game.getRollScore(i));
